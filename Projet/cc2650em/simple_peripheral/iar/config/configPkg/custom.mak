...
linker.cmd: package/cfg/app_ble_prm3.xdl
	$(SED) 's"^\"\(package/cfg/app_ble_prm3cfg.cmd\)\"$""\"E:/BeelinkerCode/simple_peripheral/Projet/cc2650em/simple_peripheral/iar/config/configPkg/\1\""' package/cfg/app_ble_prm3.xdl > $@
